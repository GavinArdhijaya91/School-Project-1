                ...
                <section className="bg-primary text-white py-20">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex justify-center space-x-4">
                            <Link to="/programs" className="bg-accent hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full transition-colors flex items-center interactive-element">
                                Lihat Program <ChevronRight size={20} className="ml-2" />
                            </Link>
                            <Link to="/staff" className="bg-transparent border-2 border-white hover:bg-white hover:text-primary font-bold py-3 px-8 rounded-full transition-colors interactive-element">
                                Staf Pengajar
                            </Link>
                        </div>
                    </div>
                ...
                <section className="py-16 bg-gray-50">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="text-center mt-10">
                            <Link to="/articles" className="btn btn-outline text-primary border-primary interactive-element">Lihat Semua Berita</Link>
                        </div>
                    </div>
                </section>
            </div>
