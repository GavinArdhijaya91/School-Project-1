                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                            {extracurriculars.map((ex) => (
                                <div key={ex.id} className="bg-white p-6 rounded-lg shadow text-center hover:bg-primary hover:text-white transition-colors group cursor-pointer interactive-element">
